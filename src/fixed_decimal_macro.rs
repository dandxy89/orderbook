...
macro_rules! fixed {
    ($val:literal i64) => {
        $crate::fixed_decimal::FixedDecimal::from_int($val)
    };
    ($val:literal i32) => {
        $crate::fixed_decimal::FixedDecimal::from_int($val as i64)
    };
    ($val:literal i16) => {
        $crate::fixed_decimal::FixedDecimal::from_int($val as i64)
    };
    ...
    (-$val:literal f64) => {{
        ...
        $crate::fixed_decimal::FixedDecimal::from_str(s).unwrap()
    }};
    (-$val:literal f32) => {{
        let s = concat!("-", stringify!($val));
        $crate::fixed_decimal::FixedDecimal::from_str(s).unwrap()
    ...
    ($val:literal) => {
        $crate::fixed_decimal::FixedDecimal::from_f64($val as f64)
    };
}
